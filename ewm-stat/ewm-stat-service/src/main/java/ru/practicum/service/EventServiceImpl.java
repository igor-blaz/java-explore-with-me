...
public class EventServiceImpl {
    ...
    public EventRequestStatusUpdateResult updateRequestStatus(
        ...
        } else if (eventRequestStatusUpdateRequest.getStatus() == CONFIRMED) {
    ...
    public List<EventFullDto> adminGetEvents(
        ...
        List<Event> events = eventStorage.getAdminEvents(users, states, categories, rangeStart, rangeEnd, from, size);
